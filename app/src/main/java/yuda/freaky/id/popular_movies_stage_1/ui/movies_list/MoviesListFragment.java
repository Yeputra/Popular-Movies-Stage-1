package yuda.freaky.id.popular_movies_stage_1.ui.movies_list;
...
import yuda.freaky.id.popular_movies_stage_1.api.APIClient;
import yuda.freaky.id.popular_movies_stage_1.api.MovieModel;
...
public class MoviesListFragment extends Fragment implements
     ...
     */
    @Bind(yuda.freaky.id.popular_movies_stage_1.R.id.grid)
    GridView gridView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(yuda.freaky.id.popular_movies_stage_1.R.layout.movie_list_fragment, container, false);
        ButterKnife.bind(this,rootView);
        mAdapter=new MoviesListAdapter(getActivity(), yuda.freaky.id.popular_movies_stage_1.R.layout.movie_list_item);
    ...
    public void onLoadFinished(Loader<List<MovieModel>> loader, List<MovieModel> loadedData) {
        if (loadedData.size()==0) {
            Toast.makeText(getActivity(),getResources().getString(yuda.freaky.id.popular_movies_stage_1.R.string.network_error),Toast.LENGTH_LONG).show();
            return;
        }
        mAdapter.clear();
